...
def test_check_non_numeric(mocker):
    """With this function we test che check related to non-numeric value passed to our script
    """
...
def test_check_positive(mocker):
    """With this function we test che check related to negative number passed to our script
    """
...
def test_to_file(tmpdir):
    """This function test to_file function that write results on file we use tmpdir from pytest
       We use also freezegun to mock datetime
    """
